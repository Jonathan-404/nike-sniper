        ...
        for keyword in keywords:
            if keyword in product_name:
                ...
                if product_url not in product_urls:
                    ...
                    webhook_send("jd_sports", product_name, product_url, scrape_product_price(product_url), "In Stock", scrape_product_sizes(product_url), scrape_product_image(product_url))
                break
